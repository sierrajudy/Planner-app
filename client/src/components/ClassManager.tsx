  ...
  return (
    <Modal title="Manage classes" onClose={onClose} width={560}>
      <div className="flex flex-col gap-5">
        ...
        <div>
          <h3 className="text-sm font-medium text-neutral-600 dark:text-neutral-300 mb-2">Classes</h3>
          <div className="flex flex-col gap-2">
            {classes.map((c) => (
              ...
              >
                ...
                />
                <button
                  className="text-xs text-neutral-500 hover:text-neutral-800 dark:hover:text-neutral-200 whitespace-nowrap"
